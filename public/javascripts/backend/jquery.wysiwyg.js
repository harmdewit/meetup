...
(function( $ )
{
    ...
    $.fn.wysiwyg = function( options )
    {
        ...
        var options = $.extend({
            html : '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">body { font-family: "Tahoma", "Verdana", sans-serif; font-size: 12px; overflow: hidden; }</style></head><body>INITIAL_CONTENT</body></html>',
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        init : function( element, options )
        {
            ...
            if ( element.nodeName.toLowerCase() == 'textarea' )
            {
                ...
                var editor = this.editor = $('<iframe frameborder="0"></iframe>').css({
